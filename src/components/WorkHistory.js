        ...
        <section className="mb-2 border-b-2 border-gray-300 break-inside-avoid">
          ...
          <ul className="pl-3 mt-2 font-normal text-gray-700 text-md leading-snugish">
            ...
            <li>
              ...
              Utilized Jira and Confluence for work and task management in an
              Agile environment, actively participating in daily standups,
              sprint planning, and sprint retrospectives to ensure efficient
